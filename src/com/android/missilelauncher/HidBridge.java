...
public class HidBridge {
    ...
    public void StartReadingThread() {
        MyAsyncTask ep1=new MyAsyncTask();
        ep1.execute(0);
        MyAsyncTask ep2=new MyAsyncTask();
        ep2.execute(1);
                ...
                synchronized (_locker) {
                    try
                    {
                        ...
                        if (r >= 0) {
                            ...
                            Log(String.format("EP:"+readEp.getAddress()+" Message received of lengths %s and content: %s", r, composeString(bytes)));
                        }
        ...
        try
        {
            ...
            synchronized (_locker) {
                ...
                for (UsbEndpoint writeEp : BulkOutEndpoint) {
                    ...
                    if (r != -1) {  
                        Log(String.format("EP:"+writeEp.getAddress()+"Written %s bytes to the dongle. Data written: %s", r, composeString(bytes)));
                    } else {
